...
namespace camera_aravis
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CameraAravisConfig &config, const CameraAravisConfig &max, const CameraAravisConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CameraAravisConfig &config1, const CameraAravisConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CameraAravisConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CameraAravisConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CameraAravisConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CameraAravisConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CameraAravisConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CameraAravisConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("ExposureAuto", "str", 0, "Automatic exposure", "{'enum': [{'name': 'Off_', 'type': 'str', 'value': 'Off', 'srcline': 14, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Use Manual Settings', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Once', 'type': 'str', 'value': 'Once', 'srcline': 15, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Once', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Continuous', 'type': 'str', 'value': 'Continuous', 'srcline': 16, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Continually', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Automatic Settings'}", &CameraAravisConfig::ExposureAuto)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("ExposureAuto", "str", 0, "Automatic exposure", "{'enum': [{'name': 'Off_', 'type': 'str', 'value': 'Off', 'srcline': 14, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Use Manual Settings', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Once', 'type': 'str', 'value': 'Once', 'srcline': 15, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Once', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Continuous', 'type': 'str', 'value': 'Continuous', 'srcline': 16, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Continually', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Automatic Settings'}", &CameraAravisConfig::ExposureAuto)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __min__.GainAuto = "";
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __max__.GainAuto = "";
...
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("GainAuto", "str", 0, "Automatic gain", "{'enum': [{'name': 'Off_', 'type': 'str', 'value': 'Off', 'srcline': 14, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Use Manual Settings', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Once', 'type': 'str', 'value': 'Once', 'srcline': 15, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Once', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Continuous', 'type': 'str', 'value': 'Continuous', 'srcline': 16, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Continually', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Automatic Settings'}", &CameraAravisConfig::GainAuto)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("GainAuto", "str", 0, "Automatic gain", "{'enum': [{'name': 'Off_', 'type': 'str', 'value': 'Off', 'srcline': 14, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Use Manual Settings', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Once', 'type': 'str', 'value': 'Once', 'srcline': 15, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Once', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Continuous', 'type': 'str', 'value': 'Continuous', 'srcline': 16, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Recalc Continually', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Automatic Settings'}", &CameraAravisConfig::GainAuto)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("AcquisitionMode", "str", 0, "Acquisition Mode", "{'enum': [{'name': 'Continuous_', 'type': 'str', 'value': 'Continuous', 'srcline': 18, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Capture continuously upon trigger.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'SingleFrame', 'type': 'str', 'value': 'SingleFrame', 'srcline': 19, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Capture one frame upon trigger.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'MultiFrame', 'type': 'str', 'value': 'MultiFrame', 'srcline': 20, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Capture multiple frames upon trigger.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'AcquisitionMode'}", &CameraAravisConfig::AcquisitionMode)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("TriggerMode", "str", 0, "TriggerMode", "{'enum': [{'name': 'Off', 'type': 'str', 'value': 'Off', 'srcline': 11, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Off', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'On', 'type': 'str', 'value': 'On', 'srcline': 12, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'On', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'On or Off'}", &CameraAravisConfig::TriggerMode)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("TriggerMode", "str", 0, "TriggerMode", "{'enum': [{'name': 'Off', 'type': 'str', 'value': 'Off', 'srcline': 11, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'Off', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'On', 'type': 'str', 'value': 'On', 'srcline': 12, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'On', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'On or Off'}", &CameraAravisConfig::TriggerMode)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      Default.abstract_parameters.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("TriggerSource", "str", 0, "Trigger Source", "{'enum': [{'name': 'Software', 'type': 'str', 'value': 'Software', 'srcline': 22, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via software', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Line1', 'type': 'str', 'value': 'Line1', 'srcline': 23, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via hardware input 1', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Line2', 'type': 'str', 'value': 'Line2', 'srcline': 24, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via hardware input 2', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'TriggerSource'}", &CameraAravisConfig::TriggerSource)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
      __param_descriptions__.push_back(CameraAravisConfig::AbstractParamDescriptionConstPtr(new CameraAravisConfig::ParamDescription<std::string>("TriggerSource", "str", 0, "Trigger Source", "{'enum': [{'name': 'Software', 'type': 'str', 'value': 'Software', 'srcline': 22, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via software', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Line1', 'type': 'str', 'value': 'Line1', 'srcline': 23, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via hardware input 1', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'Line2', 'type': 'str', 'value': 'Line2', 'srcline': 24, 'srcfile': '/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg', 'description': 'FrameStart triggered via hardware input 2', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'TriggerSource'}", &CameraAravisConfig::TriggerSource)));
//#line 273 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator.py"
...
//#line 11 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Off = "Off";
//#line 12 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_On = "On";
//#line 14 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Off_ = "Off";
//#line 15 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Once = "Once";
//#line 16 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Continuous = "Continuous";
//#line 18 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Continuous_ = "Continuous";
//#line 19 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_SingleFrame = "SingleFrame";
//#line 20 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_MultiFrame = "MultiFrame";
//#line 22 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Software = "Software";
//#line 23 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
      const char * const CameraAravis_Line1 = "Line1";
//#line 24 "/home/civerachb/Code/opg02_ws/src/camera_aravis/camera_aravis/cfg/CameraAravisConfig.cfg"
